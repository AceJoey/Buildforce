...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-green-700 via-green-600 to-yellow-400 text-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center mb-4">
                ...
                />
                <div>
                  <h3 className="text-xl font-bold">BuildForce</h3>
                  <p className="text-gray-400 text-sm">Tools and Machinery</p>
                </div>
              </div>
              <p className="text-gray-300 mb-4">
                Your trusted partner for professional tools and machinery.
              </p>
              <div className="flex space-x-4">
                {/* Social Media Icons - Links to be added later */}
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Power Tools</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Hand Tools</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Machinery</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Safety Equipment</a></li>
              </ul>
            </div>
          </div>

          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p>&copy; 2025 Buildforce Tools and Machinery. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
